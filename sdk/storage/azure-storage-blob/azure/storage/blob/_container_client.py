    ...
    def list_blobs(
        ...
        **kwargs: Any
        ...
        :keyword str end_before:
            ...
            This may be used only if use_arrow is set to True.
        :keyword int timeout:
            Sets the server-side timeout for the operation in seconds. For more details see
            https://learn.microsoft.com/rest/api/storageservices/setting-timeouts-for-blob-service-operations.
            This value is not tracked or validated on the client. To configure client-side network timesouts
        ...
        if use_arrow:
            ...
            def _arrow_cls(pipeline_response, deserialized, response_headers):
                ...
                if "application/xml" in content_type:
                    return return_context_and_deserialized(pipeline_response, deserialized, response_headers)
                ...
                # TODO: Fix this - might need to change BlobPropertiesPaged
                # They are probably not None
            ...
            #                 cls=_arrow_cls,  # closes over _arrow_cls defined above
